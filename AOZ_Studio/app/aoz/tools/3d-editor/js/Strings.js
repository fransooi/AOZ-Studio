function Strings( config ) {
	...
	const values = {
		...
		en: {
			...
			'menubar/add/objects': 'Add Object',
			'menubar/add/lights': 'Add Light',
			'menubar/add/cameras': 'Add Camera',
			'menubar/add': 'Add',
			...
			'menubar/help': 'Help',
			'menubar/help/source_code': 'Original editor Source Code',
			'menubar/help/icons': 'Icon Pack',
			'menubar/help/about': 'About of ThreeJS',
			'menubar/help/abouteditor': 'About of editor',
			...
			'sidebar/aozevents': 'AOZ Procedures',
			'sidebar/aozevents/onupdate': 'OnUpdate',
			'sidebar/aozevents/onmousedown': 'OnMouseDown',
			'sidebar/aozevents/onmouseup': 'OnMouseUp',
			'sidebar/aozevents/onmousemove': 'OnMouseMove',
			'sidebar/aozevents/onkeydown': 'OnKeyDown',
			'sidebar/aozevents/onkeyup': 'OnKeyUp',
		...
		fr: {
			...
			'menubar/file/new': 'Nouvelle scène 3D',
			'menubar/file/load': 'Ouvrir une scène 3D',
			'menubar/file/import': 'Importer un objet 3D',
			'menubar/file/export/geometry': 'Exporter Geometrie',
			'menubar/file/export/object': 'Exporter Objet',
			'menubar/file/export/scene': 'Enregistrer la scène 3D',
			...
			'menubar/add/objects': 'Ajouter un objet',
			'menubar/add/lights': 'Ajouter une lumière',
			'menubar/add/cameras': 'Ajouter une caméra',
			'menubar/add': 'Ajouter',
			...
			'menubar/help/source_code': 'Code source original',
			'menubar/help/icons': 'Pack d\'icônes',
			'menubar/help/about': 'A propos de ThreeJS',
			'menubar/help/abouteditor': 'A propos de l\'éditeur',
			...
			'sidebar/aozevents': 'Procédures AOZ',
			'sidebar/aozevents/onadd': 'OnAdd',
			'sidebar/aozevents/onupdate': 'OnUpdate',
			'sidebar/aozevents/ondelete': 'OnDelete',
			'sidebar/aozevents/onmousedown': 'OnMouseDown',
			'sidebar/aozevents/onmouseover': 'OnMouseUp',
			'sidebar/aozevents/onkeydown': 'OnKeyDown',
			'sidebar/aozevents/onkeyup': 'OnKeyUp',
			...
			'sidebar/settings/shortcuts/focus': 'Focus',
			'sidebar/settings/shortcuts/clone': 'Dupliquer',
