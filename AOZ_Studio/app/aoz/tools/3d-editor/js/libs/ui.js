...
class UIToolItem extends UIElement
{
	constructor( id, tooltip, action )
	{
		super( document.createElement( 'div') );
		if( id != 'separator' )
		{
			this.dom.className = 'tool';
			this.dom.setAttribute( 'id', id );
			this.dom.setAttribute( 'alt', tooltip );
			this.dom.setAttribute( 'title', tooltip );
			this.dom.addEventListener( 'click', action, false );
		}
		else
		{
			this.dom.className = 'separator';			
		}
	}
}
...
export { UIElement, UISpan, UIDiv, UIRow, UIPanel, UIText, UIInput, UITextArea, UISelect, UICheckbox, UIColor, UINumber, UIInteger, UIBreak, UIHorizontalRule, UIButton, UIToolItem, UIProgress, UITabbedPanel, UIListbox, ListboxItem };
