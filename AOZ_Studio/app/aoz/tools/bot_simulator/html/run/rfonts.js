...
function Fonts( aoz )
{
	...
	this.getFonts(["Red Hat Display","roboto mono"],[],"application");
	this.getFonts(["Roboto"],[],"ext_bot")
	this.getFonts([],[],"ext_clipboard")
	this.getFonts([],[],"ext_companion")
	this.getFonts(["IBM Plex Mono","Roboto"],[],"ext_debugging")
	this.getFonts([],[],"ext_json")
	this.getFonts([],[],"ext_slider")
	this.getFonts([],[],"ext_source_editor")
	this.getFonts([],[],"ext_tween")
	this.getFonts([],[],"ext_websocket")
