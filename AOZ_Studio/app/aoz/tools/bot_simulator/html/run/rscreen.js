 ...
 */
 ...
 function Screen( aoz, args, tags, callback, extra )
 {
	 ...
	 this.bobsContext.addContext("ext_bot");
this.bobsContext.addContext("ext_clipboard");
this.bobsContext.addContext("ext_companion");
this.bobsContext.addContext("ext_debugging");
this.bobsContext.addContext("ext_json");
this.bobsContext.addContext("ext_slider");
this.bobsContext.addContext("ext_source_editor");
...
this.bobsContext.addContext("v1_0_controllers");
...
this.bobsContext.addContext("v1_0_structure");
