...
function ext_websocket( aoz, args )
{
	...
	this.parent=this;
	this.root=this;
	this.manifest=JSON.parse(atob(''));
		...
		// Javascript
			...
			this.WebSocket.prototype.logOutEvent = function( event )
			{
				if ( this.logOutEventsON )
				{
					...
					this.logOutEvents.push(  { event: event, timeStamp: time } );
					this.checkLogSize();
				}
			};
			this.WebSocket.prototype.logInEvent = function( event )
			{
				...
				{
					var time = new Date().getTime();
					this.logInEvents.push( { event: event, timeStamp: time } );
					this.checkLogSize();
				}
			};
			this.WebSocket.prototype.checkLogSize = function()
			{
				if ( this.logInEventsON )
				{
					if ( this.logInEvent.length >= this.logEventsMax )
					{
						for ( var l = this.logEventsMax; l <= this.logInEvent.length; l++ )
							this.logInEvents[ l ] = null;
					}
				}
				if ( this.logOutEventsON )
				{
					if ( this.logOutEvents.length >= this.logEventsMax )
					{
						for ( var l = this.logEventsMax; l <= this.logOutEvents.length; l++ )
							this.logOutEvents[ l ] = null;
					}
				}
			};
