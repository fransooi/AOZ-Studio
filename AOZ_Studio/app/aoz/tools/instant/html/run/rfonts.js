...
function Fonts( aoz )
{
	...
	this.setWindowFont( "IBM Plex Mono","google",14,"normal","normal","normal","","application");
	this.getFonts(["roboto","IBM Plex Sans","Source code pro"],[],"application");
	this.getFonts([],[],"ext_IDE")
...
{
	name:"IBM Plex Sans",sizes:[{weight:"400",style:"normal"},{weight:"400",style:"italic"}]
};
