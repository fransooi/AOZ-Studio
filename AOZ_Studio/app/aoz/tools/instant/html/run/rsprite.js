...
Sprite.prototype.updateCollisionData = function( active )
{
	if ( this.vars.modified != this.modifiedCollisions )
	{
		...
		if ( this.imageObject && typeof this.aoz.renderer.getHardLeftX() != 'undefined' )
		{
			if ( active )
			...
			collisions.x = this.vars.x - collisions.hotSpotX - this.aoz.renderer.getHardLeftX();
			collisions.y = this.vars.y - collisions.hotSpotY - this.aoz.renderer.getHardTopY();
			collisions.xCoord = this.vars.x - this.aoz.renderer.getHardLeftX();
			collisions.yCoord = this.vars.y - this.aoz.renderer.getHardTopY();
