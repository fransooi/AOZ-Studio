...
function Errors( aoz )
{
	...
	this.errors=
	{
		...
		[
			...
			"not_running_in_ide:Your application is not running under the AOZ Editor",
			"IDE_websocket_not_opened:Websocket connection to the IDE is not opened",
			"IDE_websocket_reconnecting:Websocket is reconnecting",
			"websocket_channel_not_defined:WebSocket channel not defined (%1)",
			"websocket_error:WebSocket error: %1",
			"websocket_connexion_died:WebSocket connexion died (%1)",
			"websocket_incorrect_url:WebSocket URLs must begin with ws://"
		],
		fr:
		[
			"",
			...
			"not_running_in_ide:Votre application n'est pas en train de fonctionner sous AOZ Studio",
			"IDE_websocket_not_opened:La connexion au serveur WebSocket de l'IDE n'est pas etablie",
			"IDE_websocket_reconnecting:Websocket en reconnection",
			"websocket_channel_not_defined:WebSocket channel not defined (%1)",
			"websocket_error:WebSocket error: %1",
			"websocket_connexion_died:WebSocket connexion died (%1)",
			"websocket_incorrect_url:WebSocket URLs must begin with ws://"
