  ...
  var AudioManager = function(sounds, options) {
    ...
    WebAudioBuffer.prototype.play = function(opt_when, opt_loop, opt_volume) {
	  ...
	  if (opt_volume) {
		  ...
		  gainNode.gain.value = opt_volume;
    ...
    AudioTagSound.prototype.play = function(opt_when, opt_loop, opt_volume) {
	...
	// Phil Bell 12/10/2020 - Added this function to the library
