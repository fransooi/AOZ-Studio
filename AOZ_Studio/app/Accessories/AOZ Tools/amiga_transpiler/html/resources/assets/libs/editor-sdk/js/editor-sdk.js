application.editorSDK =
{
	...
	init: function()
	{
		...
		if( !application.editorSDK.isLocalHost( document.location.href ) )
		{
			...
			application.aoz.currentScreen.currentTextWindow.print( document.location.href, true );
	...
	{
	  return url.indexOf( 'file:' ) !== -1 || url.indexOf( 'localhost' ) !== -1 || url.indexOf( '127.0.0.1' ) !== -1;
  	},
